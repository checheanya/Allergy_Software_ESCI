...
\begin{flushright}
    ...
    \begin{bfseries}
        ...
        for\\
        \vspace{1.5cm}
        ALLERGY TRACKING APP\\
        \vspace{1.5cm}
        \LARGE{Version \myversion}\\
        \vspace{1.5cm}
        Prepared by : Anna Chechenina\\
        Yvette Dimitrova\\
        Stefano Galiano\\
        \vspace{1.5cm}
        \today\\
...
The "Breath easy" is an Android and IOS app that will help people with allergies to keep track of allergens in the nearby area. The app will contain a map where users will see alerts from other people and will be aware of specific allergens.

This will be especially relevant for people with severe allergies to prepare for the possible allergens before symptoms will hit them.

\section{Intended Audience and Reading Suggestions}

"Breath easy" is for people with allergies, mainly with air allergies such as pollen, dust, ticks, mites, and chemicals. 

\section{Project Scope}

"Breath easy" will function as a network of people with similar allergies.

\begin{itemize}
    \item Sign-in/sign-up options. The users will be able to sign up using different social networks and log in later to the created account. Once the user is registered, we will pro
    \item 
\end{itemize}
...
\begin{figure}
    \centering
    \includegraphics[width=10cm]{allergies.drawio.png}
    \caption{Diagram of functioning and sections available for users}
    \label{fig:diagram}
\end{figure}
